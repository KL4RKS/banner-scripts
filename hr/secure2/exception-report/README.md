...
Since Ellucian doesn't have a great built-in solution for switching contributions from pretax to Roth. I've prepared a solution for USU. Below I outline our current approach to prevent excess pre-tax contributions. Your institution will need to adjust it for your setup and needs for it to work. 

## **Goal**
Identify affected employees whose pre-tax contributions exceed the IRS Standard Contribution Limit. Move excess pre-tax contributions to a Roth deduction.
...
## **Initial Setup**
- Bring the [Secure 2.0 Catch-up Exceeds Pretax Allowed SQL report](CatchupExceedsPretaxAllowed.sql)\* into your reporting tool. Ideally you'll have someone review the code to understand what it's doing, and make any necessary adjustments.
...
- Set up both **pre-tax** and **post-tax** deductions for high-wage employees. Either all affected employees or you can limit to those eligible for, and electing, age catch-up contributions at the start of the year (or when elections change).
...
- [ ] Execute the **Secure 2.0 Catch-up Exceeds Pretax Allowed SQL report** and review flagged employees.
...
## **Important Notes**
If you have employees deemed eligible for the Roth Catch-up requirement based on wages earned outside of Banner, you may need to alter the **Highly Paid Individuals CTE** to include them.
